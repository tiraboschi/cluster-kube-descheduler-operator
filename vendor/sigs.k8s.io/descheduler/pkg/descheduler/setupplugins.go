...
import (
	...
	"sigs.k8s.io/descheduler/pkg/framework/plugins/kubevirtmigrationaware"
...
func RegisterDefaultPlugins(registry pluginregistry.Registry) {
	...
	pluginregistry.Register(kubevirtmigrationaware.PluginName, kubevirtmigrationaware.New, &kubevirtmigrationaware.KubevirtMigrationAware{}, &kubevirtmigrationaware.KubevirtMigrationAwareArgs{}, kubevirtmigrationaware.ValidateKubevirtMigrationAwareArgs, kubevirtmigrationaware.SetDefaults_KubevirtMigrationAwareArgs, registry)
}
